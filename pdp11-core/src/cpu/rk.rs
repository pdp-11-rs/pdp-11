...
impl Rk {
    ...
    fn read_sector(&mut self, ram: &mut Ram) {
        ...
        let sector_offset = ((cylinder as usize * 2 + surface as usize) * 12 + sector as usize) * 512;
        
        println!("RK READ: cyl={cylinder:#o} surf={surface} sec={sector:#o} -> offset={sector_offset:#o}");
